...
namespace CastleClashdb.Migrations
{
    ...
    partial class _4
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CastleClashdb.Models.CastleClash.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CastleClashdb.Models.CastleClash.AlterHeroes", b =>
                {
                    ...
                    b.HasOne("CastleClashdb.Models.CastleClash.User", "User")
                        .WithMany("AlterHeroes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CastleClashdb.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
